...
#if defined TFT_DIN && defined TFT_SCK
  #define ST7789_SOFT_SPI
#elif defined ST7789_HARD_SPI2
  #define ST7789_SPI_Write(x)  SPI2_Write(x)
#else
  #define ST7789_SPI_Write(x)  SPI1_Write(x)
#endif
